...
| gaussian-flow  + Polyfourier(init.uniform_) + Adaptive Timestemp Scaling |                                                              |                                                              |                                                              |            |
| ------------------------------------------------------------ | ------------------------------------------------------------ | ------------------------------------------------------------ | ------------------------------------------------------------ | ---------- |
...
| gaussian-flow  + Polyfourier(nn.init.kaiming_normal_) + Adaptive Timestemp Scaling |                                                              |                                                              |                                                              |                                                              |            |
| ------------------------------------------------------------ | ------------------------------------------------------------ | ------------------------------------------------------------ | ------------------------------------------------------------ | ------------------------------------------------------------ | ---------- |
...
2. KNN rigid loss
   ...
   For this part, we still used two methods. One was extracted from the paper "Gaussian Grouping: Segment and Edit Anything in 3D Scenes," but both approaches failed.
